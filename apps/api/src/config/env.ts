...
const envSchema = z.object({
  ...
  ADMIN_FRONTEND_URL: z.string().default("https://admin.aifastbooking.com"),
  OWNER_FRONTEND_URL: z.string().default("https://app.aifastbooking.com"),
  ...
  RESET_PASSWORD_URL: z.string().default("https://app.aifastbooking.com/reset-password"),
  VERIFY_EMAIL_URL: z.string().default("https://app.aifastbooking.com/verify-email"),
  STAFF_INVITE_APP_LINK: z.string().default("https://app.aifastbooking.com/download-demo-app"),
  FEEDBACK_PUBLIC_URL: z.string().default("https://app.aifastbooking.com/feedback"),
