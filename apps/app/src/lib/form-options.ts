...
export const getCountryOptions = (t: Translate) => [
...
export const getTimezoneOptions = (t: Translate) => [
...
export const getLocalePreferenceOptions = (t: Translate) => [
  { value: "vi-VN", label: t("option.locale.viVN") },
  { value: "en-US", label: t("option.locale.enUS") }
];

export const getCurrencyOptions = (t: Translate) => [
  { value: "USD", label: t("option.currency.usd") },
  { value: "CAD", label: t("option.currency.cad") },
  { value: "VND", label: t("option.currency.vnd") }
];

export const getStaffTitleOptions = (t: Translate) => [
  { value: "Senior Technician", label: t("option.staffTitle.seniorTechnician") },
  { value: "Part-time Technician", label: t("option.staffTitle.partTimeTechnician") },
  { value: "Senior Nail Technician", label: t("option.staffTitle.seniorNailTechnician") },
  { value: "Nail Technician", label: t("option.staffTitle.nailTechnician") },
  { value: "Pedicure Specialist", label: t("option.staffTitle.pedicureSpecialist") },
  { value: "Receptionist", label: t("option.staffTitle.receptionist") },
  { value: "Manager", label: t("option.staffTitle.manager") },
  { value: "Call Center Operator", label: t("option.staffTitle.callCenterOperator") }
];
